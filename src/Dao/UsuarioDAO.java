...
public class UsuarioDAO {
    ...
    public void createTableUsuarios() {
        ...
        try {
            ...
            if (! resultset.next()) {
                stmt.close();
                query = "INSERT INTO usuarios (nome, cpf, endereco, nomeUsuario, senhaUsuario, acessoUsuario)" +
    ...
    public String visualizarUsuarioDAO(){
        ...
        try {
            PreparedStatement stmt = connection.prepareStatement(query);
            ResultSet resultset = stmt.executeQuery();
            String usuarios = "ID | NOME | CPF | ENDERECO | NOME_USUARIO | ACESSO | UNIDADE\n";
            Usuario usuario;
            ...
            while (resultset.next()) {
                ...
                String u = usuario.getIdUsuario() + " | " +
                        usuario.getNome() + " | " +
                        usuario.getCpf() + " | " +
                        usuario.getEndereco() + " | "+
                        usuario.getNomeUsuario() + " | " +
                        usuario.getAcessoUsuario() + " | " +
                        usuario.getUnidadeUsuario() + " | ";
